...
def parameter_parser():
    ...
    parser.add_argument('--hidden_size', type=int, default=128, help='Hidden size for model layers')
    ...
    parser.add_argument("--adv_loss_weight", 
                        type=float, 
                        default=0.3)
    parser.add_argument("--gen_loss_weight", 
                        type=float, 
                        default=0.2)
    parser.add_argument("--dis_loss_weight", 
                        type=float, 
                        default=0.2)

    parser.add_argument('--geo_loss_weight',
                        type=float,
                        default=0.01,
    ...
    parser.add_argument('--gen_lr', type=float, default=0.0001, help='Learning rate for the generator')
    parser.add_argument('--dis_lr', type=float, default=0.0001, help='Learning rate for the discriminator')
